...
class _MembershipManagementState extends State<MembershipManagement>
  ...
  void _openEditPremiumModal(DocumentSnapshot? doc) {
    ...
    _premiumDesc.text =
        data['description'] ?? 'Access to all exclusive features.';
    _premiumMonthly.text = (data['monthlyPrice'] ?? '').toString();
    _premiumMonthlyDiscount.text =
        (data['monthlyDiscount'] ?? '').toString();
        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                MyText.titleMedium("Edit Premium Membership",
                ...
                Row(
                  children: [
                    ...
                    MySpacing.width(4),
                    MyText.bodySmall(
                      "Price syncs automatically to the mobile app.",
                  ...
                  child: MyButton(
                    onPressed: _isSaving
                      ...
                      final monthly = double.tryParse(
                          _premiumMonthly.text.trim()) ??
                          0;
                      final monthlyDiscount = double.tryParse(
                          _premiumMonthlyDiscount.text.trim()) ??
                          0;
        ...
        child: StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, snapshot) {
            ...
            final freeData = freeDoc?.data() as Map<String, dynamic>? ??
                {
                  'title': 'Free Plan',
                  'description':
                  'Basic access to explore and use limited features.'
                };

            final premiumData =
                premiumDoc?.data() as Map<String, dynamic>? ??
                    {
                      'title': 'Premium Plan',
                      'description':
                      'Unlock full access and exclusive tools.',
                      'monthlyPrice': 1999,
                      'monthlyDiscount': 0,
                    };
                      ...
                      children: [
                        Icon(
                            isPremium
                                ? LucideIcons.star
                                : LucideIcons.badge,
                            color: isPremium ? primary : Colors.green,
                            size: 22),
                        MySpacing.width(10),
                    ...
                    if (isPremium)
                      Row(
                        children: [
                          _buildInfoRow(
                            "Monthly",
                            "QAR ${monthly?.toStringAsFixed(0) ?? '0'}"
                                "${(monthlyDiscount ?? 0) > 0 ? '  (-${monthlyDiscount?.toStringAsFixed(0)}%)' : ''}",
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                ...
                                MySpacing.width(4),
                                MyText.bodySmall("Synced to app",
                      ...
                      Container(
                        ...
                        child: MyText.bodySmall("Free forever",
                            color: Colors.green[800], fontWeight: 700),
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            ...
                            child: _buildInfoRow(
                                "Active Members",
                                totalPremiumUsers.toString(),
                                icon: LucideIcons.users),
                          ),
                          _buildInfoRow("Engagement", "92%",
            ...
            return Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                MyText.titleLarge("Membership Plans",
                    fontWeight: 800, color: darkText),
                MySpacing.height(12),
                MyText.bodyMedium(
                    "Manage the membership tiers offered to users.",
                    color: Colors.grey[700]),
                MySpacing.height(30),
                isWide
                    ? Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: buildCard(
                        ...
                        isPremium: true,
                        monthly:
                        premiumData['monthlyPrice']?.toDouble(),
                        monthlyDiscount: premiumData['monthlyDiscount']
                            ?.toDouble(),
                        onEdit: () =>
                            _openEditPremiumModal(premiumDoc),
                      ),
                    ),
                  ],
                )
                  ...
                  children: [
                    ...
                    buildCard(
                      ...
                      premiumData['monthlyPrice']?.toDouble(),
                      monthlyDiscount:
                      premiumData['monthlyDiscount']?.toDouble(),
                      onEdit: () =>
                          _openEditPremiumModal(premiumDoc),
                    ),
                  ],
                ...
                MyContainer(
                  ...
                  child: Row(
                    ...
                    children: [
                      MyText.bodyMedium(
                          "Create membership plans or edit existing ones."),
                      Row(
                        children: [
                          MyButton(
                            onPressed: () async {
                              ...
                              if (doc.exists) {
                                Get.snackbar(
                                    "Free Plan",
                                    "Free plan already exists — edit Premium plan if needed.",
                                    backgroundColor:
                            ...
                            child: MyText.bodyMedium("Create Free Plan",
                                color: darkText),
                          ),
                          MySpacing.width(12),
                          MyButton(
                            onPressed: () async {
                              ...
                              if (doc.exists) {
                                Get.snackbar(
                                    "Premium Plan",
                                    "Premium plan already exists — edit if you need changes.",
                                    backgroundColor:
                                    primary.withOpacity(0.08),
                                    colorText: primary);
                              } else {
                            ...
                            borderRadiusAll: 10,
                            padding: MySpacing.xy(16, 10),
                            child: MyText.bodyMedium("Create Premium Plan",
                                color: Colors.white),
                          ),
                        ],
                      )
