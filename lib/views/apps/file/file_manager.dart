...
class _FileManagerState extends State<FileManager> with SingleTickerProviderStateMixin, UIMixin {
                      ...
                      child: MyCard(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            MySpacing.height(24),
                            buildCreateNew("Home", LucideIcons.house),
                            MySpacing.height(16),
                            buildCreateNew("Document", LucideIcons.file),
                            MySpacing.height(16),
                            buildCreateNew("Download", LucideIcons.folder_down),
                            MySpacing.height(16),
                            buildCreateNew("Music", LucideIcons.music),
                            MySpacing.height(16),
                            buildCreateNew("Picture", LucideIcons.image),
                            MySpacing.height(16),
                            buildCreateNew("Video", LucideIcons.square_play),
                            MySpacing.height(16),
                            buildCreateNew("Recent", LucideIcons.clock_4),
                            MySpacing.height(16),
                            buildCreateNew("Delete File", LucideIcons.trash_2),
                            MySpacing.height(40),
                            MyText.bodySmall(
                              "STORAGE",
                              fontWeight: 700,
                            ...
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(text: '(50%) of  ', style: MyTextStyle.bodyMedium()),
                                  TextSpan(
                                    text: '2 GB',
                                    style: MyTextStyle.bodyMedium(
                                      fontWeight: 700,
                            ...
                            Center(
                              child: MyButton(
                                ...
                                backgroundColor: contentTheme.primary.withAlpha(28),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              spacing: 20,
                              children: [
                                buildFileData(contentTheme.warning, LucideIcons.file_archive, "File.zip", 12582912),
                                buildFileData(contentTheme.info, LucideIcons.layout_grid, "Apps", 4939212390),
